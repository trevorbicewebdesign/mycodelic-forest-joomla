...
LOCK TABLES `jos_virtuemart_calc_manufacturers` WRITE;
/*!40000 ALTER TABLE `jos_virtuemart_calc_manufacturers` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_virtuemart_calc_manufacturers` ENABLE KEYS */;
UNLOCK TABLES;
