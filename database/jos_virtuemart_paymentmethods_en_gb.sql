...
LOCK TABLES `jos_virtuemart_paymentmethods_en_gb` WRITE;
/*!40000 ALTER TABLE `jos_virtuemart_paymentmethods_en_gb` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_virtuemart_paymentmethods_en_gb` ENABLE KEYS */;
UNLOCK TABLES;
