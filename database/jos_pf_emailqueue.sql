...
DROP TABLE IF EXISTS `jos_pf_emailqueue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_pf_emailqueue` (
...
LOCK TABLES `jos_pf_emailqueue` WRITE;
/*!40000 ALTER TABLE `jos_pf_emailqueue` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_pf_emailqueue` ENABLE KEYS */;
UNLOCK TABLES;
