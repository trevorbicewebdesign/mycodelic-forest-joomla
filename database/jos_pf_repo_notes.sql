...
DROP TABLE IF EXISTS `jos_pf_repo_notes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_pf_repo_notes` (
...
LOCK TABLES `jos_pf_repo_notes` WRITE;
/*!40000 ALTER TABLE `jos_pf_repo_notes` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_pf_repo_notes` ENABLE KEYS */;
UNLOCK TABLES;
