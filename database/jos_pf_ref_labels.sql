...
DROP TABLE IF EXISTS `jos_pf_ref_labels`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_pf_ref_labels` (
...
LOCK TABLES `jos_pf_ref_labels` WRITE;
/*!40000 ALTER TABLE `jos_pf_ref_labels` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_pf_ref_labels` ENABLE KEYS */;
UNLOCK TABLES;
