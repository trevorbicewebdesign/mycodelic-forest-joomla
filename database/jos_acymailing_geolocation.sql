...
DROP TABLE IF EXISTS `jos_acymailing_geolocation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_acymailing_geolocation` (
...
LOCK TABLES `jos_acymailing_geolocation` WRITE;
/*!40000 ALTER TABLE `jos_acymailing_geolocation` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_acymailing_geolocation` ENABLE KEYS */;
UNLOCK TABLES;
