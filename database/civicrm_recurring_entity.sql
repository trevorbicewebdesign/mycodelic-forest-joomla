...
LOCK TABLES `civicrm_recurring_entity` WRITE;
/*!40000 ALTER TABLE `civicrm_recurring_entity` DISABLE KEYS */;
/*!40000 ALTER TABLE `civicrm_recurring_entity` ENABLE KEYS */;
UNLOCK TABLES;
