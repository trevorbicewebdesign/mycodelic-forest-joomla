...
DROP TABLE IF EXISTS `jos_rsform_constantcontact`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_rsform_constantcontact` (
...
LOCK TABLES `jos_rsform_constantcontact` WRITE;
/*!40000 ALTER TABLE `jos_rsform_constantcontact` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_rsform_constantcontact` ENABLE KEYS */;
UNLOCK TABLES;
