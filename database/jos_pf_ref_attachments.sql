...
DROP TABLE IF EXISTS `jos_pf_ref_attachments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_pf_ref_attachments` (
...
LOCK TABLES `jos_pf_ref_attachments` WRITE;
/*!40000 ALTER TABLE `jos_pf_ref_attachments` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_pf_ref_attachments` ENABLE KEYS */;
UNLOCK TABLES;
