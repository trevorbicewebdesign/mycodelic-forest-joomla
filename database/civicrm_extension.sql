...
INSERT INTO `civicrm_extension` (`id`, `type`, `full_name`, `name`, `label`, `file`, `schema_version`, `is_active`) VALUES (1,'module','com.aghstrategies.uscounties','US County Loader','US County Loader','uscounties',NULL,1);
INSERT INTO `civicrm_extension` (`id`, `type`, `full_name`, `name`, `label`, `file`, `schema_version`, `is_active`) VALUES (2,'module','org.civicrm.sms.twilio','twilio','twilio','twilio',NULL,1);
