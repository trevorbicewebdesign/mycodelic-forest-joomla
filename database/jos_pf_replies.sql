...
DROP TABLE IF EXISTS `jos_pf_replies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_pf_replies` (
...
LOCK TABLES `jos_pf_replies` WRITE;
/*!40000 ALTER TABLE `jos_pf_replies` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_pf_replies` ENABLE KEYS */;
UNLOCK TABLES;
