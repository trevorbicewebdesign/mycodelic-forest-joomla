 ...
 * @since        1.6
 */
class campbudgetModelReceipts extends JModelList
{
    /**
     * Constructor.
     *
    ...
    public function getItemQuery()
    {
        ...
        $query->from($db->quoteName('#__campbudget_users') . ' AS u');
    ...
    public function getListQuery()
    {
        ...
        $query->from('#__campbudget_receipts AS r');

		
		$query->order($db->escape('r.id DESC'));
