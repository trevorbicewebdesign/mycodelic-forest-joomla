...
class campbudgetModelItem extends JModelAdmin {
	...
	public function getForm($data = array(), $loadData = true) {
		...
		// Get the form.
		$form = $this->loadForm('com_campbudget.item', 'item', array('control' => 'jform', 'load_data' => $loadData));
	...
	public function getSpecificform($data = array(), $loadData = true) {
		
		
		// Get the form.
		$form = $this->loadForm('com_campbudget.specific', 'specific', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData() {
		...
		$data = JFactory::getApplication()->getUserState('com_campbudget.edit.item.data', array());

		if (empty($data)) {	
			$data = $this->getItem();
		}
		$this->preprocessData('com_campbudget.item', $data);
	...
	public function getItem($id = null) {
		...
		$query->from($db->quoteName('#__campbudget_items') . ' AS i');
		$query->where("i.id = '" . $id."' ");
		// Reset the query using our newly populated query object.
		$db->setQuery($query);
