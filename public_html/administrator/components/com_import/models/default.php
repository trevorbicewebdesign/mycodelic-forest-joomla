...
class importModelDefault extends JModelLegacy {
	var $_query;
	var $_data;
	var $_total			= null;
	...
	function _buildQuery() {
		...
		$sortColumn			= $mainframe->getUserStateFromRequest('com_import.default.sortColumn','filter_order','q.id');
		$sortOrder			= $mainframe->getUserStateFromRequest('com_import.default.sortOrder','filter_order_Dir','desc');
		
		$mainframe->setUserState('com_import.default.sortColumn',$sortColumn);
		$mainframe->setUserState('com_import.default.sortOrder',$sortOrder);
