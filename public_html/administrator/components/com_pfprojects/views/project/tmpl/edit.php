...
<form action="<?php echo JRoute::_('index.php?option=com_pfprojects&view=project&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate" enctype="multipart/form-data">
 <div class="row-fluid">
