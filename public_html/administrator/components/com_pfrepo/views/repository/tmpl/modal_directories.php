...
if ($this_dir->parent_id > 1) : ?>
    <tr class="row1">
        <td class="center"></td>
        <td colspan="6">
            <a href="<?php echo JRoute::_('index.php?option=com_pfrepo&view=repository&filter_parent_id=' . $this_dir->parent_id . $link_append);?>">
                ..
            </a>
        </td>
    </tr>
...
foreach ($this->items['directories'] as $i => $item) :
    $link = 'index.php?option=com_pfrepo&view=repository&filter_parent_id=' . $item->id . $link_append;
