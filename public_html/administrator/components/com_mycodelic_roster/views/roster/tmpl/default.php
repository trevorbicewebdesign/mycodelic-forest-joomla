		...
		<thead>
			<tr>
				...
				<th class="nowrap" width="5%" align="left">
					<?php echo JHtml::_('grid.sort', 'Year', 				'i.year', 	$listDirn, $listOrder); ?>
				</th>
				<th class="nowrap" width="5%" align="left">
					<?php echo JHtml::_('grid.sort', 'Members', 				'i.quantity', 		$listDirn, $listOrder); ?>
				</th>
			</tr>
		</thead>
		<tbody>
			...
			$link = JRoute::_('index.php?option=com_mycodelic_roster&view=year&year=' . (int) $item->year);
			...
			?>
				<tr>
					...
					<td><a href="<?php echo $link; ?>"><?php echo $item->members; ?></a></td>
