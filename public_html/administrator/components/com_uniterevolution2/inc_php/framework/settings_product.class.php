...
<div class="thumb_wrapper">
				...
				<input type="button" id="<?php echo $buttonID?>" class='button-image-select <?php echo $class?>' value="<?php _uge('Choose Image',REVSLIDER_TEXTDOMAIN); ?>"></input>

				<input type="button" class="button-image-remove button-primary revred" id="<?php echo $buttonRemoveID; ?>" value="<?php _uge('Remove',REVSLIDER_TEXTDOMAIN); ?>" />
			...
			?>
				...
				<tr id="<?php echo $setting["id_row"]?>" <?php echo $rowStyle ?> valign="top">
					...
					<td colspan="4" align="right" <?php echo $cellStyle?>>
						...
						<span class="unite-settings-static-text"><?php echo $setting["text"]?></span>
		...
		protected function drawSettingRow($setting){
			...
			?>
				...
				<tr id="<?php echo $setting["id_row"]?>" <?php echo $rowStyle ?> <?php echo $class?> valign="top">
					...
					<?php /*?><td class="description_container_in_td">
