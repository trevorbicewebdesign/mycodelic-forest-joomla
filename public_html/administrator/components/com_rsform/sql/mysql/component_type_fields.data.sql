...
(9, 'MULTIPLE', 'select', 'NO\r\nYES', '{"case":{"YES":{"show":["FILESSEPARATOR","MINFILES","MAXFILES"],"hide":[]},"NO":{"show":[],"hide":["FILESSEPARATOR","MINFILES","MAXFILES"]}}}', 1),
(9, 'MINFILES', 'textbox', '1', 'numeric', 2),
(9, 'MAXFILES', 'textbox', '0', 'numeric', 2),
(9, 'FILESSEPARATOR', 'textbox', '<br />', '', 4),
