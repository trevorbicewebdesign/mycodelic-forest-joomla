...
<div class="shl-main-content wbl-theme-default">
    ...
    <form method="post" action="index.php?option=com_sh404sef&c=metas&layout=default&view=metas" name="adminForm"
          id="adminForm" class="shl-no-margin">
							...
							if ($this->itemCount > 0)
							{
								for ($i = 0; $i < $this->itemCount; $i++)
								{
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <textarea class="text_area" id="metatitle<?php echo $url->id; ?>"
                                                      name="metatitle[<?php echo $url->id; ?>]" cols="40"
                                                      rows="5"><?php echo $this->escape($url->metatitle); ?></textarea>
                                        </td>

                                        <td class="center">
                                            <textarea class="text_area" id="metadesc<?php echo $url->id; ?>"
                                                      name="metadesc[<?php echo $url->id; ?>]" cols="40"
                                                      rows="5"><?php echo $this->escape($url->metadesc); ?></textarea>
                                        </td>
