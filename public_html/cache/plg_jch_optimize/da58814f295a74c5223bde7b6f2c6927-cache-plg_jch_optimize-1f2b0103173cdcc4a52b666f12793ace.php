<?php die("Access Denied"); ?>#x#a:2:{s:6:"result";s:162717:"try{(function(window,undefined)
{var
...
a(target).collapse(option)})}(window.jfbcJQuery);}catch(e){console.error('Error in file:/media/sourcecoast/js/jq-bootstrap-1.8.3.js; Error:'+e.message);};";s:6:"output";s:0:"";}