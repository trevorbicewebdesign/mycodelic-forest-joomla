<?php die("Access Denied"); ?>#x#a:2:{s:6:"result";s:6468:".off-canvas-toggle {
  border-radius: 0;
  border: 0;
...
.t3-off-canvas .t3-off-canvas-body .dropdown-menu .dropdown-submenu > a:hover,
.t3-off-canvas .t3-off-canvas-body .dropdown-menu .dropdown-submenu:hover > a {
  color: #9fcdec;
}
