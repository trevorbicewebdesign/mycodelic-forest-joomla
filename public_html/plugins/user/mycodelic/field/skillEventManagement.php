 ...
 * @since       3.3.7
 */
class JFormFieldSkillEventManagement extends JFormFieldCheckboxes
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  3.3.7
	 */
	protected $type = 'skillEventManagement';
	...
	protected function getLabel()
	{
		...
		if ($text)
		{
			...
			$layout = new JLayoutFile('plugins.user.profile.fields.skill_eventmanagement');
    ...
    public function getOptions() {           
        $skillList = [];
        $skillList[] = "Crowd Management";
        $skillList[] = "Event Operations";
        $skillList[] = "Security";
