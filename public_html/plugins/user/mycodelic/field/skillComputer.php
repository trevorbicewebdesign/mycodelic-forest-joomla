 ...
 * @since       3.3.7
 */
class JFormFieldSkillComputer extends JFormFieldCheckboxes
{
	/**
	 * The form field type.
	 *
    ...
    public function getOptions() {           
        ...
        $skillList[] = "Unix";
        $skillList[] = "Linux";
        $skillList[] = "CAD Software";
        $skillList[] = "Graphics/Illustration Software";
        $skillList[] = "Photo Editing Softwar";
        $skillList[] = "Presentation/Multi-Media";
        $skillList[] = "Project Management Software";
        $skillList[] = "Spreadsheets";
        $skillList[] = "Conferencing Tools";
        $skillList[] = "Word Processing";
