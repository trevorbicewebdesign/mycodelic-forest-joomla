 ...
 * @since       3.3.7
 */
class JFormFieldSkillConstruction extends JFormFieldCheckboxes
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  3.3.7
	 */
	protected $type = 'skillConstruction';
	...
	protected function getLabel()
	{
		...
		if ($text)
		{
			...
			$layout = new JLayoutFile('plugins.user.profile.fields.skill_construction');
    ...
    public function getOptions() {           
        $skillList = [];
        $skillList[] = "Carpenter";
        $skillList[] = "Heavy Equipment Operator";
        $skillList[] = "Labor";
        $skillList[] = "Mechanic";
        $skillList[] = "Mover";
        $skillList[] = "Plumber";
        $skillList[] = "Structural Engineer";
        $skillList[] = "Surveying";
        $skillList[] = "Truck Driver";
        $skillList[] = "Welding";
        $skillList[] = "House Painter";
