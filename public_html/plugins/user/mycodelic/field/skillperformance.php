 ...
 * @since       3.3.7
 */
class JFormFieldSkillPerformance extends JFormFieldCheckboxes
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  3.3.7
	 */
	protected $type = 'skillPerformance';
	...
	protected function getLabel()
	{
		...
		if ($text)
		{
			...
			$layout = new JLayoutFile('plugins.user.profile.fields.skill_performance');
    ...
    public function getOptions() {           
        $skillList = [];
        $skillList[] = "Circus Performance";
        $skillList[] = "Dancer";
        $skillList[] = "Fire Dancer";
        $skillList[] = "Musician";
        $skillList[] = "Set Dressing";
        $skillList[] = "Costumer";
        $skillList[] = "Drummer";
        $skillList[] = "MCing";
        $skillList[] = "Performer";
