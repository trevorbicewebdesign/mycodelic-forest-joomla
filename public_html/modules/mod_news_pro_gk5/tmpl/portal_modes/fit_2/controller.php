...
$document->addStyleSheet('modules/mod_news_pro_gk5/tmpl/portal_modes/fit_2/slick/slick.css');
$document->addScript('modules/mod_news_pro_gk5/tmpl/portal_modes/fit_2/slick/slick.min.js');
...
class NSP_GK5_FIT_2 {
    ...
    $news_config_json = '{
  	...
  	$contentarr = array_merge($controller_data['arts'], $controller_data['featured']);
		...
		// main wrapper
		echo '<div id="' . $module_id . '" class="nspMain gkNspPM gkNspPM-Fit_2" data-config="'.$news_config_json.'">';
