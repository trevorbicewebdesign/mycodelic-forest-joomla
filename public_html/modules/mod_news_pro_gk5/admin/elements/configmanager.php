...
class JFormFieldConfigManager extends JFormField {
	...
	protected function getInput() {
		...
		if (isJoomla4()) {
			...
			$html .= '<div class="control-group"><label>'.JText::_('MOD_NEWS_PRO_GK5_CONFIG_SAVE').'</label><div class="input-group"><input type="text" id="config_manager_save_filename" class="form-control input-medium" /><span class="input-group-addon input-group-text">.json</span><span class="input-group-btn"><button id="config_manager_save" class="btn btn-secondary"><i class="icon-upload"></i> '.JText::_('MOD_NEWS_PRO_GK5_CONFIG_SAVE_BTN').'</button></span></div></div>';
