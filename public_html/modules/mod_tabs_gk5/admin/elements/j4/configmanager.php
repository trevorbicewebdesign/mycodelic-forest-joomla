...
class JFormFieldConfigManager extends JFormField {
	...
	protected function getInput() {
		...
		$html .= $msg;
		$html .= '<div class="control-group"><label>'.JText::_('MOD_TABS_GK5_CONFIG_LOAD').' </label><div class="input-group">'.$file_select.'<span class="input-group-btn"><button class="btn btn-secondary" id="config_manager_load"><i class="icon-download"></i>'.JText::_('MOD_TABS_GK5_CONFIG_LOAD_BTN').' </button></span></div></div>';
		$html .= '<div class="control-group"><label>'.JText::_('MOD_TABS_GK5_CONFIG_SAVE').' </label><div class="input-group"><input class="form-control" type="text" id="config_manager_save_filename" /><span class="input-group-text">.json</span><span class="input-group-btn"><button class="btn btn-secondary" id="config_manager_save"><i class="icon-upload"></i>'.JText::_('MOD_TABS_GK5_CONFIG_SAVE_BTN').'</button></span></div></div>';
		$html .= '<div class="control-group"><label>'.JText::_('MOD_TABS_GK5_CONFIG_DELETE').' </label><div class="input-group">'.$file_delete.'<span class="input-group-btn"><button class="btn btn-secondary"  id="config_manager_delete"><i class="icon-remove"></i>'.JText::_('MOD_TABS_GK5_CONFIG_DELETE_BTN').'</button></span></div></div>';
