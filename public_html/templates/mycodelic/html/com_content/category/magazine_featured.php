...
<div class="magazine-featured">
	<div class="row">
		<div class="col-md-8 th-margin-right-wrapper">
			<?php if (count ($leading)): ?>
				<div id="magazine-featured-leading" class="magazine-leading magazine-featured-leading carousel slide"  data-ride="carousel">
					

 <div class="carousel-inner">
					<?php foreach ($leading as $index=>$item) :?>

<?php
if( $index==0 ){ $activeClass="active"; }else{$activeClass="";}
?>

						<div class="magazine-item item <?php echo $activeClass ?>">

							<?php echo JLayoutHelper::render('joomla.content.intro_image', $item); ?>

						<div class="th-slide-des">
							...
							<?php if ($params->get('show_readmore') && $item->readmore) :
								...
								<section class="readmore">
									<a class="th-read-more" href="<?php echo $link; ?>"><span>
		...
		<a class="left carousel-control" href="#magazine-featured-leading" data-slide="prev">
		<i class="fa fa-angle-left"></i>
		</a>
		<a class="right carousel-control" href="#magazine-featured-leading" data-slide="next">
...
<!--Featured Article Column-->
	...
	<div class="row">
		...
		<div class="col-md-4">
			<?php if (count ($links)): ?>
				<div class="magazine-links magazine-featured-links th-margin-right-wrapper">
