...
?>
<div class="sprocket-headlines th-box navigation-active animation-<?php echo $parameters->get('headlines_animation'); ?>" data-headlines="<?php echo $parameters->get('module_id'); ?>">
	<div class="sprocket-headlines-container">
		...
		<div class="sprocket-headlines-navigation">
			...
			<span class="arrow prev" data-headlines-previous><i class="fa fa-angle-left"></i></span>
		</div>
		<?php endif; ?>
	</div>
</div>
