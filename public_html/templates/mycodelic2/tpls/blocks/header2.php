...
<header class="wrap">
	<div class="container"> 
		...
		<div class="navbar-brand logo logo-<?php echo $logotype ?>"> <a href="<?php echo JURI::base(true) ?>" title="<?php echo strip_tags($sitename) ?>">
			The Mycodelic Forest</a></div>
		<!-- //LOGO -->
		...
		<div class="navbar navbar-default t3-mainnav"> 
			...
			<!-- //NAVBAR MAIN --> 
			<script type="text/javascript">new menuFixer('.t3-navbar > ul.nav');</script>
		</div>
	</div>
</header>
<!-- //MAIN NAVIGATION -->
