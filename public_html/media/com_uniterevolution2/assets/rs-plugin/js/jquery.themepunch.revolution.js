		...
		var vimeoready_auto = function(player_id,autoplay) {
			...
			var updateHTML5Size = function(pc,container) {
								...
								if (handlecaption==0) {
									...
									if (nextcaption.hasClass("tp-videolayer") || nextcaption.find('iframe').length>0 || nextcaption.find('video').length>0 ) {
										...
										var frameID = "iframe"+Math.round(Math.random()*100000+1),
											youtubeHolderID = "tp_youtube_holder"+Math.round(Math.random()*100000+1),
				...
				if (vidytid!=undefined && String(vidytid).length>1 && nextcaption.find('iframe').length==0) {
					...
					//add youtube holder
					//nextcaption.append('<div class="tp-resizeme" style="width:'+vidw+'px;height:'+vidh+'px;background-color:green;"><div id="'+youtubeHolderID+'" class="tp-youtube-holder"></div></div>');
					nextcaption.append('<div id="'+youtubeHolderID+'" class="tp-youtube-holder"></div>');
			...
			//handle youtube new
			if(nextcaption.find(".tp-youtube-holder").length != 0){
				var objYoutubeHolder = nextcaption.find(".tp-youtube-holder");
				opt.nextslideatend = nextcaption.data('nextslideatend');
								
				var hasHandler = (objYoutubeHolder.html() != "");
				
				if(hasHandler == false){	//put youtube
					try {
					...
					var ytint = setInterval(function() {
						...
						if (typeof YT != "undefined" && YT && YT != undefined)
							if (typeof YT.Player != undefined && typeof YT.Player !="undefined") {
								...
								player = new YT.Player(youtubeHolderID, {
						          height: vidh,
						          width: vidw,
						          videoId: vidytid,
						          playerVars:{
								...
								var objYoutubeHolder = nextcaption.find("iframe.tp-youtube-holder");
								if(objYoutubeHolder.length){
									handleResponsiveIframe(nextcaption,opt);
								}
				...
				}else{	//continue youtube handling
				 ...
				 */
				var handleResponsiveIframe = function(nextcaption,opt){
