		...
		<thead>
			<tr>
				...
				<th class="nowrap" width="5%" align="left">
					<?php echo JHtml::_('grid.sort', 'Status', 					'u.status', 		$listDirn, $listOrder); ?>
				</th>
				<th class="nowrap" width="5%" align="left">
					<?php echo JHtml::_('grid.sort', 'Name', 					'users.name', 		$listDirn, $listOrder); ?>
				</th>
				<th class="nowrap" width="5%" align="left">
		...
		<tbody>
			...
			?>
				<tr>
					...
					<td><a href="<?php echo $link; ?>">Yes</a></td>
					...
					<td><a href="<?php echo $link; ?>"><?php echo $item->cb_phone; ?></a></td>
				</tr>			
			<?php $j++;endforeach; ?>
		</tbody>
		<tfoot>
